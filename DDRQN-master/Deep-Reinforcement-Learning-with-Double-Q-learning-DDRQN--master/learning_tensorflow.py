...
fname_formats = ("tf-dtc-{}.csv", "tf-dtc-q-{}.csv")
results_path = "results/tf-dtc/"
model_name = "tf-model"
mode = True
if len(argv) > 1:
	...
	score_file= open(results_path + 'tf-dtc.csv', 'w+')
    ...
    if not skip_learning:
        for epoch in range(epochs):
            ...
            for test_episode in trange(test_episodes_per_epoch, leave=False):
                ...
                score = game.get_total_reward()
                print(unicode("{},{},{},{}".format(kills, deaths, 26 - ammo, score)),
