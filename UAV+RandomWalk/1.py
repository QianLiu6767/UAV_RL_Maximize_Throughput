# !usr/bin/env python
# -*- coding:utf-8 -*-
# Author:LiuQian,time:2018/7/19

# 高斯马尔科夫移动模型+Q_learning
import pandas as pd
...
def update():
    ...
    plt.savefig('average_return_50000.eps', bbox_inches='tight')
    plt.show()
    ...
    plt.xlabel('Training Episodes', font2)
    plt.savefig('average_migration_50000.eps', bbox_inches='tight')
    plt.show()
