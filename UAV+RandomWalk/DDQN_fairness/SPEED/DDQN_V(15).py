...
V = np.random.uniform(15, 1, 15)                # 人群移动速度
...
class Maze(tk.Tk, object):
    def __init__(self):
        ...
        self.title('UAV测试环境-DDQN-(15, 1)-50m-15TU')
...
def run_maze():
    ...
    plt.plot(x1, r1, marker='o', label='DDQN-50m-15TU-(15, 1)', markersize=10)
    ...
    plt.plot(x1, y1, marker='o', label='DDQN-50m-15TU-(15, 1)', markersize=10)
