...
V = np.random.uniform(14, 1, 15)                # 人群移动速度
...
class Maze(tk.Tk, object):
    def __init__(self):
        ...
        self.title('UAV测试环境-DDQN-(14, 1)-50m-15TU')
    ...
    def update_env(self, speed, angle):
        ...
        for i in range(15):
            ...
            speed[i] = 0.99 * speed[i] + (1 - 0.99) * 16.67 + (1 - 0.99) ** 2 * np.random.normal(1, 0.1, 1)  # 更新ith用户的速度
...
def run_maze():
    ...
    plt.plot(x1, r1, marker='o', label='DDQN-50m-15TU-(14, 1)', markersize=10)
    ...
    plt.plot(x1, y1, marker='o', label='DDQN-50m-15TU-(14, 1)', markersize=10)
