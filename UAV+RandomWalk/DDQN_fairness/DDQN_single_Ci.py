...
class Maze(tk.Tk, object):
    def __init__(self):
        ...
        self.title('UAV测试环境-DDQN-50m-改变Fc')
...
def run_maze():
    ...
    print("计算复杂度-1000；CPU计算频率：Fc=1.5GHz")
    print("每回合step数：", np.mean(STEP))
    print("每回合吞吐量：", np.mean(episode_migration1))
