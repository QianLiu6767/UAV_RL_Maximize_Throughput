...
def run_maze():
    ...
    plt.plot(x1, r1, marker='o', label='DQN-100m', markersize=10)
    ...
    plt.savefig('a_r_DQN_100m_20000.eps', bbox_inches='tight')
    plt.show()
    ...
    plt.plot(x1, g1, marker='o', label='DQN-100m', markersize=10)
    ...
    plt.xlabel('Training Episodes', font2)
    plt.savefig('a_t_DQN_100m_20000.eps', bbox_inches='tight')
    plt.show()
    ...
    plt.plot(x1, y1, marker='o', label='DQN-100m', markersize=10)
    ...
    plt.xlabel('Training Episodes', font2)
    plt.savefig('E_t_DQN_100m_20000.eps', bbox_inches='tight')
    plt.show()
