...
# DQN + 高斯马尔科夫移动模型 + 用户关联 + 用户速度、角度随机，移动模型中有高斯变量（初始位置变化） + 用户公平性 + 约束无人机最后一点尽可能的近一点
# 改变用户密度-10个用户
...
class Maze(tk.Tk, object):
    def __init__(self):
        ...
        self.title('UAV测试环境-DQN-100m-10TU')
...
def run_maze():
    ...
    plt.plot(x1, r1, marker='o', label='DQN-100m-10TU', markersize=10)
    ...
    plt.plot(x1, y1, marker='o', label='DQN-100m-10TU', markersize=10)
