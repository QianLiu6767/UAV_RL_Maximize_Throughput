...
class DeepQNetwork:
    ...
    def plot_cost(self):
        ...
        """
        plt.plot(np.arange(len(self.cost_his)), self.cost_his, marker='o', label='learning_rate=0.1', markersize=10)
        ...
        plt.plot(x, y, marker='o', label='learning_rate=0.1', markersize=10)
...
class DeepQNetwork3:
    ...
    def plot_cost(self):
        ...
        #plt.plot(np.arange(len(self.cost_his__)), self.cost_his)
        font1 = {'family': 'Times New Roman',
                 'weight': 'normal',
                 'size': 20}
