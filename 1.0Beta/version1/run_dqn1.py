...
from DQN_brain1 import DeepQNetwork
from DQN_brain1 import DeepQNetwork2
from DQN_brain1 import DeepQNetwork3
...
def run_maze():
    ...
    plt.plot(np.linspace(0, len(average_return1), N), average_return1, label='BatteryLevel1')
    #plt.plot(np.linspace(0, len(average_return2), N), average_return2, label='BatteryLevel2')
    #plt.plot(np.linspace(0, len(average_return3), N), average_return3, label='BatteryLevel3')
    plt.legend(loc=4)
