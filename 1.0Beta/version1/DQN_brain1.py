...
class DeepQNetwork:
    ...
    def plot_cost(self):
        ...
        plt.plot(x, y, marker='o', label='learning_rate α=0.1', markersize=10)
        #plt.plot(np.arange(len(self.cost_his)), self.cost_his)
...
class DeepQNetwork2:
    ...
    def plot_cost(self):
        ...
        plt.plot(x_, y_, marker='^', label='learning_rate α=0.05', markersize=10)
...
class DeepQNetwork3:
    ...
    def plot_cost(self):
        ...
        plt.plot(x__, y__, marker='x', label='learning_rate α=0.01', markersize=10)
